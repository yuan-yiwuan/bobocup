    ...
    <>
      ...
      <main className="flex-1 mx-auto w-full max-w-2xl px-4 py-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Section title="⭐ 加倍与主队加成">
            <ul className="list-disc pl-5 space-y-0.5">
              <li>
                <b>八强赛开始</b>的比赛可加倍到 <b>2 倍</b>（淘汰赛 200~400 根胡萝卜）
              </li>
              <li>
                <b>季军赛</b>（三四名决赛）也可投，<b>最多 2 倍</b>
              </li>
              <li>在设置里选一个主队</li>
              <li>
                只要是 <b>自己主队的比赛</b>，任选都可投到 <b>3 倍</b>
                （小组赛 100~300、淘汰赛 200~600 根胡萝卜；季军赛除外，最多 2 倍）
              </li>
