      ...
      <main className="flex-1 mx-auto w-full max-w-2xl px-4 py-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Section title="🥕 胡萝卜王">
            <ul className="list-disc pl-5 space-y-0.5">
              <li>
                猜 <b>谁到最后净胡萝卜最多</b>，选项是<b>当前排行榜上的玩家</b>
              </li>
              <li>
                赔率按<b>当前收成榜</b>每天更新：现在越领先、赔率越低
              </li>
              <li>
                用 <b>🥦 西蓝花</b>下注，一注 <b>200 西蓝花</b>
                （独立货币，<b>不影响你的胡萝卜</b>）
              </li>
              <li>一旦竞猜不可修改或撤销；世界杯结束后按最终收成榜<b>手动揭晓</b></li>
            </ul>
          </Section>
          ...
          <Section title="⭐ 加倍规则">
            <ul className="list-disc pl-5 space-y-0.5">
              <li>
                任何比赛都可加倍到 <b>2 倍</b>（小组赛 200、淘汰赛 400 根胡萝卜）
              </li>
              <li>在设置里选一个主队</li>
              <li>
                <b>自己主队的比赛</b>（主队在场，任选胜/平/负）可到 <b>5 倍</b>
                （小组赛 500、淘汰赛 1000）
              </li>
